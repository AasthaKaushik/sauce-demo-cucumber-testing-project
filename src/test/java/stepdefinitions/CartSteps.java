...
public class CartSteps {
    ...
    public void verify_product_added() {
        ...
        assertTrue(PageFactory.getCartPage().isGreyJacketInCart(), "Grey Jacket should be in the cart");
    }
    ...
    public void correct_product_page_displayed() {
        Assert.assertEquals(PageFactory.getCartPage().isNoirJacketURL(), "https://sauce-demo.myshopify.com/collections/frontpage/products/noir-jacket");
    }
